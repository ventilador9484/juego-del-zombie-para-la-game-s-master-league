...
function draw() {
  ...
  if (estadoNivel === 3) {
    ...
    if (estadoJuego3 === 1 && estado === 23) {
      ...
      if (vidaZ3 === 0) {
        bulletG.destroyEach(); //  zombie3.lifetime = 1;
...
function aleatorio(min, maxi) {
  ...
  return resultado;
} // cuando ganen en el nivel 2 existe la posibilidad de que aparezaca un rectangulo gris, el cual va bajando,
// para alejarlo pueden avanzar con la flecha derecha y al mismo tiempo dar un salto y de esa manera este 
// se va a ir
// me he esforzado demasiado en este juego y lo he dado todo de mi